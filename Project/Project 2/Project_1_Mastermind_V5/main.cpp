 ...
 * Purpose:  Project 1: Mastermind V5
 */
...
int main(int argc, char** argv) {
    ...
    for (int i=0; i<NUM_GUESS; i++){
        ...
        guesses.setGuess1(g1);
        guesses.setGuess2(g2);
        guesses.setGuess3(g3);
        guesses.setGuess4(g4);
        guesses.setGuess5(g5);
        
        if (guesses.getGuess1() == colors.print1()){
            cout<<"O"<<endl;
        }else if (guesses.getGuess1() == colors.print2() || guesses.getGuess1() == colors.print3() ||
                guesses.getGuess1() == colors.print4() || guesses.getGuess1() == colors.print5()){
            cout<<"X"<<endl;
        }else{
            cout<<" "<<endl;
        }
        if (guesses.getGuess2() == colors.print2()){
            cout<<"O"<<endl;
        }else if (guesses.getGuess2() == colors.print1() || guesses.getGuess2() == colors.print3() ||
                guesses.getGuess2() == colors.print4() || guesses.getGuess2() == colors.print5()){
            cout<<"X"<<endl;
        }else{
            cout<<" "<<endl;
        }
        if (guesses.getGuess3() == colors.print3()){
            cout<<"O"<<endl;
        }else if (guesses.getGuess3() == colors.print1() || guesses.getGuess3() == colors.print2() ||
                guesses.getGuess3() == colors.print4() || guesses.getGuess3() == colors.print5()){
            cout<<"X"<<endl;
        }else{
            cout<<" "<<endl;
        }
        if (guesses.getGuess4() == colors.print4()){
            cout<<"HIDDEN"<<endl;
        }else if (guesses.getGuess4() == colors.print1() || guesses.getGuess4() == colors.print2() ||
                guesses.getGuess4() == colors.print3() || guesses.getGuess4() == colors.print5()){
            cout<<"HIDDEN"<<endl;
        }else{
            cout<<"HIDDEN"<<endl;
        }
        if (guesses.getGuess5() == colors.print5()){
            cout<<"HIDDEN"<<endl;
        }else if (guesses.getGuess5() == colors.print1() || guesses.getGuess5() == colors.print2() ||
                guesses.getGuess5() == colors.print3() || guesses.getGuess5() == colors.print4()){
            cout<<"HIDDEN"<<endl;
        }else{
            cout<<"HIDDEN"<<endl;
        }
        if (guesses.getGuess1() == colors.print1() && guesses.getGuess2() == colors.print2() &&
                guesses.getGuess3() == colors.print3() && guesses.getGuess4() == colors.print4() &&
                guesses.getGuess5() == colors.print5()){
